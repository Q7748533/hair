/* HairToolsReview — Site JS (GA + Consent + UI)
   Extracted from inline scripts for maintainability */
...
gtag('js', new Date());
gtag('config', 'G-HFT4XZ2YB2');

/* Defer gtag.js library until idle or user interaction */
(function(){
  var loaded = false;
  function loadGA(){
    if (loaded) return;
...
/* ---------- Site UI: Cookie Banner, Scroll, Back-to-Top, Mobile Nav ---------- */
(function(){
